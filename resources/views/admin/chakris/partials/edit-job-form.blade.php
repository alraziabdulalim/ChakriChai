<form action="{{ route('admin.chakris.update', $chakri->id) }}" method="POST">
    @csrf
    @method('PUT')
    {{-- Job Title --}}
    <div>
    ...
    <div class="mt-8">
        ...
        <select
            ...
            @foreach (App\Enums\EmploymentType::cases() as $type)
                <option value="{{ $type->value }}" @selected(old('employment_type', $chakri->employment_type->value) === $type->value)>
    ...
    <div class="mt-8">
        ...
        <input
            ...
            value="{{ old('company_name', $chakri->company_name) }}"
    ...
    <div class="mt-8">
        ...
        <input
            class='mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-indigo-600 dark:focus:ring-indigo-600'
            id="apply_url" type="url" name="apply_url" value="{{ old('apply_url', $chakri->apply_url) }}"
    ...
    <div class="mt-8">
        ...
        <textarea
            class='mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-indigo-600 dark:focus:ring-indigo-600'
            id="description" name="description" rows="3" name="description" placeholder="e.g. Senior Laravel Developer">{{ old('description', $chakri->description) }}</textarea>
        @error('description')
            <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                {{ $message }}
            </p>
    ...
    <div class="mt-8">
        ...
        <input
            class='mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-indigo-600 dark:focus:ring-indigo-600'
            id="salary" name="salary" type="text" value="{{ old('salary', $chakri->salary) }}"
    ...
    <div class="mt-8">
        ...
        <input
            ...
            value="{{ old('company_logo', $chakri->company_logo) }}"
